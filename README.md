...
The second webpage will retrieve the saved data and display the user’s results. For the poll, this page will show the user’s selected favorites and what was the most preferred by other users. For the quiz, it will display the correct and wrong answers of the questions.
