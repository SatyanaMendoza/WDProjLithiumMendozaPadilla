...
Firstly, the poll will be used to collect information about the users’ Stardew Valley favorites. This poll will include questions asking for their preferences in the game, such as their favorite farm animal, bachelor, bachelorette, or season. After submitting the poll, the website will display how many other users chose the same favorites in each category. The collected responses will be saved locally on the user’s computer using the browser’s storage, allowing the results to be shown without requiring an online database.

Secondly, an HTML form will be used to create a 15-point multiple-choice quiz about Stardew Valley trivia found on our website. After reading through the encyclopedia sections, users may take the quiz to test their knowledge of the Background Story, the Valley, the Bachelors and Bachelorettes, and the Villagers. Once the form is submitted, the user’s answers will be automatically checked, their score will be tallied, and their result will be displayed on the screen. The score will also be stored on the user’s computer so they can view their previous result. Users who score 6 and below will be classified as beginner farmers, scores from 7 to 11 as intermediate farmers, and scores of 12 and above as professional farmers.

JavaScript will be used to tally their scores and to classify them accordingly. Additionally, JS will be used to save their most recent classification based on the most recent quiz the user has taken. 
