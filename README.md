...
Secondly, an HTML form will be used to create a 15-point multiple-choice quiz about Stardew Valley trivia found on our website.  This will also be made in HTML using radio buttons.  After reading through the encyclopedia sections, users may take the quiz to test their knowledge of the Background Story, the Valley, the Bachelors and Bachelorettes, and the Villagers. Once the form is submitted, the user’s answers will be automatically checked, their score will be tallied, and their result will be displayed on the screen. The score will also be stored on the user’s computer so they can view their previous result. Users who score 6 and below will be classified as beginner farmers, scores from 7 to 11 as intermediate farmers, and scores of 12 and above as professional farmers.

JavaScript will be used to tally their scores and to classify them accordingly. Additionally, JS will be used to save a history of the previous quizzes answered by the user.  With this, the user can keep track of which questions they got wrong and which ones they got right.  This way, the user can learn from their mistakes and keep track of their improvements.
